...
public class GovNewsPageProcesser implements PageProcessor {
    ...
    public void process(Page page) {
        ...
        if (page.getUrl().regex(URL_LIST).match()) {
            ...
            page.putField("source", Utils.replaceHTML(page.getHtml().xpath("//div[@class='article-colum']/div[@class='pages-date']/span[@class='font'][2]").toString()));
            page.putField("author", Utils.replaceHTML(page.getHtml().xpath("//div[@class='article-colum']/div[@class='pages_content']/div[@class='editor']").toString()));
